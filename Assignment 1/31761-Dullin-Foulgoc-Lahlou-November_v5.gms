...
*Subsets of conventional/renewable producers
conv(j)$(ord(j)<16)=yes;
ren(j)$(ord(j)>15)=yes;
*Subsets of producers with special operational hours
op('G6')=yes;
op('G8')=yes
;
...
*$call gdxxrw.exe consumption.xlsx output=consumption_nov.gdx squeeze=n par=cons rng=Novembre2019!C1:F721 cdim=1 rdim=1
$gdxin consumption_nov.gdx
$load cons
$gdxin

*$call gdxxrw.exe wind.xlsx output=wind.gdx squeeze=n par=wind rng=Novembre2020!C1:E745 cdim=1 rdim=1
$gdxin wind.gdx
$load wind
$gdxin
...
*Getting market prices through dual values
l_s1(t) = bal1.m(t);
l_s2(t) = bal2.m(t);

*Getting the amount of wind curtailed
wind_cut(j,t)$ren(j) = P(j,t)-y.l(j,t);

DISPLAY C.l,y.l,delta.l,shed1.l,shed2.l,l_s1,l_s2;
...
$onEcho > howToRead_market_clearing_nov.txt
var = C.l rng=Clearing_nov!A2
squeeze=n EpsOut=0 var = y.l rng=Clearing_nov!B5 rdim=2
squeeze=n EpsOut=0 par = l_s1 rng=Clearing_nov!F5 rdim=1
squeeze=n EpsOut=0 par = l_s2 rng=Clearing_nov!J5 rdim=1
squeeze=n EpsOut=0 var = shed1.l rng=Misc_nov!B5 rdim=1
squeeze=n EpsOut=0 var = shed2.l rng=Misc_nov!F5 rdim=1
squeeze=n EpsOut=0 var = delta.l rng=Misc_nov!J5 rdim=1
squeeze=n EpsOut=0 par = wind_cut rng=Misc_nov!N5 rdim=2

$offEcho

execute_unload "market_clearing_nov.gdx" C.l y.l l_s1 l_s2 shed1.l shed2.l delta.l wind_cut
execute 'gdxxrw.exe market_clearing_nov.gdx o=market_clearing_v5.xls @howToRead_market_clearing_nov.txt'
